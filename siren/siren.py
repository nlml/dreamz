...
class SineLayer(nn.Module):
    ...
    def __init__(
        ...
        self._periodic_activation = act_fn
    ...
    def forward(self, input):
        return self._periodic_activation(self.omega_0 * self.linear(input))

    def forward_with_intermediate(self, input):
        # For visualization of activation distributions
        intermediate = self.omega_0 * self.linear(input)
        return self._periodic_activation(intermediate), intermediate
...
class Siren(nn.Module):
    ...
    def forward(self, coords, act_fn=None, dim=2):
        ...
        return output.view(1, s, s, 3).permute(0, 3, 1, 2)  # .sigmoid_()
